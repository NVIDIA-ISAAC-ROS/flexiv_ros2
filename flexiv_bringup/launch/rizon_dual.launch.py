...
def generate_launch_description():
    ...
    kinematics_params_file_left_param_name = "kinematics_params_file_left"
    kinematics_params_file_right_param_name = "kinematics_params_file_right"
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            kinematics_params_file_left_param_name,
            default_value="",
    ...
    kinematics_xacro_args = [
        PythonExpression(
            [
                "'kinematics_parameters_file_left:=",
        ...
        PythonExpression(
            [
                "'kinematics_parameters_file_right:=",
